...
//         stacks = ITLStacks1155(vyperDeployer.deployContract("TLStacks1155", abi.encode(address(this))));
...
//             address(0)
//         );
//         nftTwo = ERC1155TL(address(proxyTwo));
//         vm.startPrank(nftOwner);
//         nftTwo.setApprovedMintContracts(mintAddrs, true);
//         nftTwo.createToken('https://arweave.net/1', addresses, amounts);
//         vm.stopPrank();
//     }
...
//             10
//         );
//         stacks.update_drop_param(address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.DURATION, bytes32(uint256(7200)));
//         stacks.close_drop(address(nft), 1);
...
//         stacks.configure_drop(address(1), 1, 100, 1, address(0), address(1), 100, 0, 0, bytes32(0), 100, 0);
//         vm.expectRevert("contract is paused");
//         stacks.close_drop(address(1), 1);
//         vm.expectRevert("contract is paused");
//         stacks.update_drop_param(address(1), 1, DropPhase.PUBLIC_SALE, DropParam.DURATION, bytes32(uint256(100)));
//         vm.expectRevert("contract is paused");
//         bytes32[] memory proof = new bytes32[](0);
//         stacks.mint(address(1), 1, 1, address(2), proof, 1);
...
//             emit DropConfigured(nftOwner, address(nft), block.number, 1);
//         }
...
//         if (doesNotRevert) {
//             Drop memory drop = stacks.get_drop(address(nft), 1);
...
//             0
//         );
//         uint256 prevRound = stacks.get_drop_round(address(nft), 1);

//         vm.expectEmit(true, true, false, false);
//         emit DropClosed(nftOwner, address(nft), 1);
//         stacks.close_drop(address(nft), 1);

//         uint256 currRound = stacks.get_drop_round(address(nft), 1);
...
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PRESALE, DropParam.MERKLE_ROOT, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PRESALE, DropParam.MERKLE_ROOT, paramValue);
//         // presale cost
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PRESALE, DropParam.COST, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PRESALE, DropParam.COST, paramValue);
//         // presale duration
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PRESALE, DropParam.DURATION, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PRESALE, DropParam.DURATION, paramValue);
//         // public allowance
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.ALLOWANCE, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.ALLOWANCE, paramValue);
//         // public cost
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.COST, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.COST, paramValue);
//         // public duration
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.DURATION, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.DURATION, paramValue);
//         // start time
//         vm.expectEmit(true, true, false, true);
//         emit DropUpdated(nftOwner, address(nft), 1, DropPhase.BEFORE_SALE, DropParam.START_TIME, paramValue);
//         stacks.update_drop_param(address(nft), 1, DropPhase.BEFORE_SALE, DropParam.START_TIME, paramValue);

//         // expect revert
//         vm.expectRevert("unknown param update");
//         stacks.update_drop_param(address(nft), 1, DropPhase.PRESALE, DropParam.START_TIME, paramValue);
//         vm.expectRevert("unknown param update");
//         stacks.update_drop_param(address(nft), 1, DropPhase.PUBLIC_SALE, DropParam.MERKLE_ROOT, paramValue);
//         vm.expectRevert("unknown param update");
//         stacks.update_drop_param(address(nft), 1, DropPhase.BEFORE_SALE, DropParam.COST, paramValue);
//         vm.expectRevert("unknown param update");
//         stacks.update_drop_param(address(nft), 1, DropPhase.NOT_CONFIGURED, DropParam.COST, paramValue);
...
//         stacks.mint(address(nft), 1, 0, address(this), emptyProof, 0);
//     }
...
//         stacks.mint(address(nft), 1, 1, address(this), emptyProof, 0);
...
//         stacks.mint(address(nft), 1, 1, minter, emptyProof, 1);
//     }
...
//         stacks.mint{value: 0.005 ether}(address(nft), 1, 5, ben, emptyProof, 0);
//         assert(prevBalance - ben.balance == 0.004 ether);
//         assert(nft.balanceOf(ben, 1) == 4);
...
//         vm.startPrank(ben);
//         uint256 prevBalance = ben.balance;
//         stacks.mint{value: 0.005 ether}(address(nft), 1, 1, ben, emptyProof, 0);
//         assert(prevBalance - ben.balance == 0.001 ether);
//         assert(nft.balanceOf(ben, 1) == 1);
...
//         stacks.mint{value: 0.001 ether}(address(nft), 1, 1, ben, emptyProof, 0);
...
//         stacks.mint{value: 0.001 ether}(address(nft), 1, 1, chris, emptyProof, 0);
//         stacks.mint{value: 0.001 ether}(address(nft), 1, 1, david, emptyProof, 0);
//         stacks.mint{value: 0.001 ether}(address(nft), 1, 1, ben, emptyProof, 0);
//         vm.stopPrank();

//         assert(nft.balanceOf(chris, 1) == 1);
//         assert(nft.balanceOf(david, 1) == 1);
//         assert(nft.balanceOf(ben, 1) == 1);
//         assert(prevETHBalance - ben.balance == 0.003 ether);
//         assert(stacks.get_num_minted(address(nft), 1, chris) == 1);
//         assert(stacks.get_num_minted(address(nft), 1, david) == 1);
//         assert(stacks.get_num_minted(address(nft), 1, ben) == 1);
...
//         stacks.mint(address(nft), 1, 1, chris, emptyProof, 0);
//         stacks.mint(address(nft), 1, 1, david, emptyProof, 0);
//         stacks.mint(address(nft), 1, 1, ben, emptyProof, 0);
//         vm.stopPrank();

//         assert(nft.balanceOf(chris, 1) == 2);
...
//             emit Purchase(ben, ben, address(nft), 1, address(0), 1, presaleCost, true);
//             stacks.mint{value: presaleCost}(address(nft), 1, 1, ben, recipientProof, 1);
//             assert(nft.balanceOf(ben, 1) == 1);
...
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(chris, chris, address(nft), 1, address(0), 2, presaleCost, true);
//             stacks.mint{value: 2 * presaleCost}(address(nft), 1, 2, chris, recipientProof, 3);
//             assert(nft.balanceOf(chris, 1) == 2);
...
//             payoutBalance = receiver.balance;
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(chris, chris, address(nft), 1, address(0), 1, presaleCost, true);
//             stacks.mint{value: presaleCost}(address(nft), 1, 1, chris, recipientProof, 3);
//             assert(nft.balanceOf(chris, 1) == 3);
...
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(david, david, address(nft), 1, address(0), 4, presaleCost, true);
//             stacks.mint{value: 4 * presaleCost}(address(nft), 1, 4, david, recipientProof, 4);
//             assert(nft.balanceOf(david, 1) == 4);
...
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(bsy, bsy, address(nft), 1, address(0), 5, presaleCost, true);
//             stacks.mint{value: 5 * presaleCost}(address(nft), 1, 5, bsy, recipientProof, 5);
//             assert(nft.balanceOf(bsy, 1) == 5);
...
//             vm.expectRevert("not part of allowlist");
//             stacks.mint{value: 5 * presaleCost}(address(nft), 1, 5, minter, recipientProof, 5);
//             vm.stopPrank();
...
//                 vm.expectEmit(true, true, true, true);
//                 emit Purchase(ben, ben, address(nft), 1, address(0), 3, publicCost, false);
//                 stacks.mint{value: 3*publicCost}(address(nft), 1, 3, ben, recipientProof, 1);
//                 assert(nft.balanceOf(ben, 1) == 4);
//                 assert(recipientBalance - ben.balance == 3*publicCost);
//                 assert(receiver.balance - payoutBalance == 3*publicCost);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint{value: publicCost}(address(nft), 1, 1, ben, recipientProof, 1);
//                 vm.stopPrank();
...
//                 recipientProof = m.getProof(data, 1);
//                 vm.expectEmit(true, true, true, true);
//                 emit Purchase(chris, chris, address(nft), 1, address(0), 1, publicCost, false);
//                 stacks.mint{value: publicCost}(address(nft), 1, 1, chris, recipientProof, 1);
//                 assert(nft.balanceOf(chris, 1) == 4);
//                 assert(recipientBalance - chris.balance == publicCost);
//                 assert(receiver.balance - payoutBalance == publicCost);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint{value: publicCost}(address(nft), 1, 1, chris, recipientProof, 3);
//                 vm.stopPrank();

//                 vm.startPrank(david);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint{value: publicCost}(address(nft), 1, 1, david, emptyProof, 4);
//                 vm.stopPrank();

//                 vm.startPrank(bsy);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint{value: publicCost}(address(nft), 1, 1, bsy, emptyProof, 5);
//                 vm.stopPrank();
//             }
...
//             payoutBalance = receiver.balance;
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(minter, minter, address(nft), 1, address(0), 3, publicCost, false);
//             stacks.mint{value: 3 * publicCost}(address(nft), 1, 3, minter, emptyProof, 0);
//             assert(nft.balanceOf(minter, 1) == 3);
//             assert(recipientBalance - minter.balance == 3 * publicCost);
//             assert(receiver.balance - payoutBalance == 3 * publicCost);
//             recipientBalance = minter.balance;
//             payoutBalance = receiver.balance;
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(minter, minter, address(nft), 1, address(0), 1, publicCost, false);
//             stacks.mint{value: publicCost}(address(nft), 1, 1, minter, emptyProof, 0);
//             assert(nft.balanceOf(minter, 1) == 4);
...
//         drop = stacks.get_drop(address(nft), 1);
...
//             vm.startPrank(ben);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(ben, ben, address(nft), 1, address(coin), 1, presaleCost, true);
//             stacks.mint(address(nft), 1, 1, ben, recipientProof, 1);
//             assert(nft.balanceOf(ben, 1) == 1);
...
//             recipientProof = m.getProof(data, 1);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(chris, chris, address(nft), 1, address(coin), 2, presaleCost, true);
//             stacks.mint(address(nft), 1, 2, chris, recipientProof, 3);
//             assert(nft.balanceOf(chris, 1) == 2);
...
//             payoutBalance = coin.balanceOf(receiver);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(chris, chris, address(nft), 1, address(coin), 1, presaleCost, true);
//             stacks.mint(address(nft), 1, 1, chris, recipientProof, 3);
//             assert(nft.balanceOf(chris, 1) == 3);
...
//             recipientProof = m.getProof(data, 2);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(david, david, address(nft), 1, address(coin), 4, presaleCost, true);
//             stacks.mint(address(nft), 1, 4, david, recipientProof, 4);
//             assert(nft.balanceOf(david, 1) == 4);
...
//             recipientProof = m.getProof(data, 3);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(bsy, bsy, address(nft), 1, address(coin), 5, presaleCost, true);
//             stacks.mint(address(nft), 1, 5, bsy, recipientProof, 5);
//             assert(nft.balanceOf(bsy, 1) == 5);
...
//             vm.startPrank(minter);
//             vm.expectRevert("not part of allowlist");
//             stacks.mint(address(nft), 1, 5, minter, recipientProof, 5);
//             vm.stopPrank();
...
//                 recipientProof = m.getProof(data, 0);
//                 vm.expectEmit(true, true, true, true);
//                 emit Purchase(ben, ben, address(nft), 1, address(coin), 3, publicCost, false);
//                 stacks.mint(address(nft), 1, 3, ben, recipientProof, 1);
//                 assert(nft.balanceOf(ben, 1) == 4);
...
//                 recipientProof = m.getProof(data, 1);
//                 vm.expectEmit(true, true, true, true);
//                 emit Purchase(chris, chris, address(nft), 1, address(coin), 1, publicCost, false);
//                 stacks.mint(address(nft), 1, 1, chris, recipientProof, 1);
//                 assert(nft.balanceOf(chris, 1) == 4);
...
//                 vm.startPrank(david);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint(address(nft), 1, 1, david, emptyProof, 4);
//                 vm.stopPrank();

//                 vm.startPrank(bsy);
//                 vm.expectRevert("already hit mint allowance");
//                 stacks.mint(address(nft), 1, 1, bsy, emptyProof, 5);
//                 vm.stopPrank();
//             }
...
//             payoutBalance = coin.balanceOf(receiver);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(minter, minter, address(nft), 1, address(coin), 3, publicCost, false);
//             stacks.mint(address(nft), 1, 3, minter, emptyProof, 0);
//             assert(nft.balanceOf(minter, 1) == 3);
...
//             payoutBalance = coin.balanceOf(receiver);
//             vm.expectEmit(true, true, true, true);
//             emit Purchase(minter, minter, address(nft), 1, address(coin), 1, publicCost, false);
//             stacks.mint(address(nft), 1, 1, minter, emptyProof, 0);
//             assert(nft.balanceOf(minter, 1) == 4);
...
//     function test_two_mints_going_on_separate_contracts() public {
//         vm.startPrank(nftOwner);
//         stacks.configure_drop(
//             address(nft),
//             1,
...
//         vm.startPrank(minter);
//         assert(stacks.get_drop_phase(address(nft), 1) == DropPhase.PUBLIC_SALE);
//         assert(stacks.get_drop_phase(address(nftTwo), 1) == DropPhase.BEFORE_SALE);

//         stacks.mint(address(nft), 1, 1, minter, emptyProof, 0);
//         assert(stacks.get_num_minted(address(nft), 1, minter) == 1);
//         assert(stacks.get_num_minted(address(nftTwo), 1, minter) == 0);

//         vm.warp(block.timestamp + 3600);

//         assert(stacks.get_drop_phase(address(nft), 1) == DropPhase.ENDED);
//         assert(stacks.get_drop_phase(address(nftTwo), 1) == DropPhase.PUBLIC_SALE);

//         stacks.mint(address(nftTwo), 1, 5, minter, emptyProof, 0);

//         assert(stacks.get_num_minted(address(nft), 1, minter) == 1);
//         assert(stacks.get_num_minted(address(nftTwo), 1, minter) == 5);
//         vm.stopPrank();
//     }

//     /// @dev test two mints going on at the same time on the same contract
//     function test_two_mints_going_on_same_contract() public {
//         vm.startPrank(nftOwner);
//         stacks.configure_drop(
//             address(nft),
//             1,
...
//         vm.startPrank(minter);
//         assert(stacks.get_drop_phase(address(nft), 1) == DropPhase.PUBLIC_SALE);
//         assert(stacks.get_drop_phase(address(nft), 2) == DropPhase.BEFORE_SALE);

//         stacks.mint(address(nft), 1, 1, minter, emptyProof, 0);
//         assert(stacks.get_num_minted(address(nft), 1, minter) == 1);
//         assert(stacks.get_num_minted(address(nft), 2, minter) == 0);

//         vm.warp(block.timestamp + 3600);

//         assert(stacks.get_drop_phase(address(nft), 1) == DropPhase.ENDED);
//         assert(stacks.get_drop_phase(address(nft), 2) == DropPhase.PUBLIC_SALE);

//         stacks.mint(address(nft), 2, 5, minter, emptyProof, 0);

//         assert(stacks.get_num_minted(address(nft), 1, minter) == 1);
//         assert(stacks.get_num_minted(address(nft), 2, minter) == 5);
//         vm.stopPrank();
//     }
// }
